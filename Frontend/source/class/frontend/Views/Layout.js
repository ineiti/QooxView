...
qx.Class.define("frontend.Views.Layout", {
  ...
  members: {
    ...
    fadeIn: function(){
      ...
      if ( aform && aform.fields ){
        if ( aform.getContainerElement().getDomElement() ){
          ...
          aform.effect = new qx.fx.effect.core.Fade(aform.getContainerElement().getDomElement());
          aform.effect.set({
            from: 0.5,
            to: 1,
            duration: 0.25
      ...
      if ( this.field && this.field.fields && 
        this.field.fields.childLayout ){
        this.field.fields.childLayout.fadeIn();
      }
    },
    
    parentEnableAll: function(){
      if ( this.parentLayout ){
        this.parentLayout.enableAll();
      } else {
        this.enableAll();
      }
    },
    ...
    enableAll: function(){
      ...
      if ( this.field && this.field.fields ){
        this.field.fields.setEnabled( true );
        if ( this.field.fields.childLayout ){
          this.field.fields.childLayout.enableAll();
        }
      }
    },
    ...
    changeView: function(e){
      this.checkTimer();
      if ( this.field.fields.childLayout ){
        this.field.fields.childLayout.checkTimer();
      }
